...
function ESMCssName( ) {
  ...
  this.cssName_init = function( cssRoot ) {
    ...
    if (cssRoot)
      ...
      this.cssRoot = ESM.defaultAttributes.cssroot;
  }
  /*set overridable methods*/
...
ESM._msExit = function() {this.userData.setState('hover',false);}
ESM._dnIn = function() {this.userData.setState('pressed',true);}
ESM._upIn = function() {this.userData.setState('pressed',false);}
ESM._clkIn = function() {this.userData.setState('clicked',true);}
ESM._clkOut = function() {this.userData.setState('clicked',false);}
ESM._focIn = function() {this.userData.setState('focused',true);}
ESM._focOut = function() {this.userData.setState('focused',false);}
ESM._evs = { 
...
ESM.getCssRules = function( styleSheet ) {
  //(workaround for occasional bug in FF, prevents script 
  // stopping with 'SecurityError: The operation is insecure.')
  var rules = null;
  if (styleSheet) {
    try {
